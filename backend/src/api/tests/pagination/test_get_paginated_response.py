...
class GetPaginatedResponseTests(TestCase):
    def setUp(self):
        ...
        self.user1 = user_create(username="Ahmed", password="123456", email="user1@hacksoft.io")
        self.user2 = user_create(username="Ahmed2", password="123456", email="user2@hacksoft.io")
